...
import { editFood, getOneFood } from "../JS/Actions/food"; // pas d'emoji dans le code
...
const EditFood = () => {
  ...
  // ✅ CORRECT (d'après combineReducers: food: foodReducer)
  const { oneFood, loading, errors } = useSelector((state) => state.food);

  // ✅ CORRECT (d'après combineReducers: user: userReducer)
  ...
  return (
    <div className="editfood-page">
      <div className="editfood-card">
        ...
        <p className="editfood-subtitle">Update the details below</p>
